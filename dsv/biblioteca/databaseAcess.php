<?php
	require_once dirname(__FILE__).'/../dba/database.php';//banco de dados

	function selectListaTodasSubCategorias(){
		$sql = "SELECT c.idCategoria, s.idSubCategoria, c.tituloCategoria, s.tituloSubCategoria
		        FROM categoria  c
	...
	function selectListaUmaCategoria($id){
		$sql = "SELECT c.idCategoria, s.idSubCategoria, c.tituloCategoria, s.tituloSubCategoria
		        FROM categoria  c
				JOIN subCategoria s using(idCategoria)
