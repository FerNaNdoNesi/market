    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?php //anuncio.php?c=1&s=9&a=6
			if(isset($_GET['c']) && !isset($_GET['s']))
            	echo'<input type="hidden" name="local" value="anuncio.php?c='.$_GET['c'].'">';
			else	
			if(isset($_GET['c']) && isset($_GET['s']) && !isset($_GET['a']))
            	echo'<input type="hidden" name="local" value="anuncio.php?c='.$_GET['c'].'&s='.$_GET['s'].'">';
			else
			if(isset($_GET['c']) && isset($_GET['s']) && isset($_GET['a']))
            	echo'<input type="hidden" name="local" value="anuncio.php?c='.$_GET['c'].'&s='.$_GET['s'].'&a='.$_GET['a'].'">';
			else
				echo'<input type="hidden" name="local" value="anuncio.php">';
