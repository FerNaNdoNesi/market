...
<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="#"><i class="glyphicon glyphicon-usd"></i> Market</a>
    </div>
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><i class="glyphicon glyphicon-plus"></i> Novo Anúncio</a></li>
        <li class="dropdown">
...
<div class="row">
	<div class="col-md-3">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li><a href="#"><i2 class="glyphicon glyphicon-star"></i2> Mais visitados</a></li>
        <li><a href="#"><i2 class="glyphicon glyphicon-star-empty"></i2> Melhores anúncios</a></li>
        <li><a href="#"><i2 class="glyphicon glyphicon-star-empty"></i2> Eventos</a></li>
        <li><a href="#"><i2 class="glyphicon glyphicon-star-empty"></i2> Promoções</a></li>
      </ul>
    ...
    <div class="col-md-9">
      ...
      <strong><i class="glyphicon glyphicon-th"></i> CLASSIFICADOS </strong>  
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            <a href="#" class="thumbnail"> teste
              <img data-src="holder.js/100%x180" alt="Imóveis">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-6 col-md-3">
            <a href="#" class="thumbnail">
              <img data-src="holder.js/100%x180" alt="Automóveis">
            </a>
          </div>
          <div class="col-xs-6 col-md-3">
            <a href="#" class="thumbnail">
